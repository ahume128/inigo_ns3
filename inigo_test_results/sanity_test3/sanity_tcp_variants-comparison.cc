...
int main (int argc, char *argv[])
{
  ...
  CommandLine cmd;
  cmd.AddValue ("transport_prot", "Transport protocol to use: TcpNewReno, TcpWestwood, TcpWestwoodPlus ", transport_prot);
  ...
  std::string file_prefix = "/Users/ahume/Documents/UCSC/Thesis/inigo_ns3/inigo_test_results/sanity_test3/TcpVariantsComparison_" + transport_prot;
  std::string tr_file_name = file_prefix + "-ascii";
  std::string cwnd_tr_file_name = file_prefix + "-cwnd.data";
  std::string ssthresh_tr_file_name = file_prefix + "-ssth.data";
  std::string rtt_tr_file_name = file_prefix + "-rtt.data";
  std::string rto_tr_file_name = file_prefix + "-rto.data";
