...
int main (int argc, char *argv[])
{
  ...
  std::string prefix_file_name = "/Users/ahume/Documents/UCSC/Thesis/inigo_ns3/inigo_test_results/test7/TcpVariantsComparison_";
  bool tracing = true;
  double data_mbytes = 0.0025;
  ...
  cmd.AddValue ("transport_prot", "Transport protocol to use: TcpNewReno, "
                " TcpInigo, TcpWestwood, TcpWestwoodPlus ", transport_prot);
  ...
  for (uint16_t i = 0; i < sources.GetN (); i++)
    {
      ...
      if (transport_prot.compare ("TcpNewReno") == 0
          ...
          || transport_prot.compare ("TcpCubic") == 0)
        {
          ...
          ftp.SetConstantRate(20000,tcp_adu_size);
